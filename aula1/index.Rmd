...
![Figura 4: Juro Real x Juro Neutro](img_r/img1.png){width="100%"} 
<br>
...
colnames(pib) <- c('Agro', 'Ind', 'Serv', 'PIB', 'CF', 'CG', 'FBCF', 'X', 'M')
...
colnames(pib_sa) <- c('Agro', 'Ind', 'Serv', 'PIB', 'CF', 'CG', 'FBCF', 'X', 'M')

#Analise do PIB e seus componentes
dates <- seq(as.Date('1996-01-01'), as.Date('2022-09-01'), by='3 month')
...
dates <- seq(as.Date('1996-04-01'), as.Date('2022-09-01'), by='3 month')
...
dates <- seq(as.Date('1997-01-01'), as.Date('2022-07-01'), by='3 month')
#Conjuntura6
...
dates <- seq(as.Date('1997-10-01'), as.Date('2022-07-01'), by='3 month')
#Conjuntura7
