...
desagregado <- ts(desagregado, start=c(2000,1), freq=12)
...
#https://sidra.ibge.gov.br/tabela/8159
...
dates <- seq(as.Date('2002-02-01'), as.Date('2022-12-01'), by='1 month')
#Conjuntura12
...
dates <- seq(as.Date('2001-01-01'), as.Date('2023-01-01'), by='1 month')
