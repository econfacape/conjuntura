...
```{r mba14, fig.cap = 'Figura 12: Evolução Inflação em paises selecionados'}
...
```{r mba15, fig.width  = 9}
#datainfl0 <- get_sidra(api='t/1737/n1/all/v/2266/p/all/d/v2266%2013') #Populacao
...
#### Contribuicoes Mensais para o indice cheio
...
Nesta análise os dados trabalhados são obtidos das séries 20361 (Concessões de crédito - Total), 20362 (Concessões de crédito - Pessoas jurídicas - Total), 20633 (Concessões de crédito - Pessoas físicas - Total), 20634 (Concessões de crédito com recursos livres - Total) e 20685 (Concessões de crédito com recursos direcionados). 
...
* 20361 (Concessões de crédito - Total): 

* 20362 (Concessões de crédito - Pessoas jurídicas - Total):

* 20633 (Concessões de crédito - Pessoas físicas - Total): 
...
```{r mba25, fig.cap = 'Taxa de Juros % a.a.'}
#dados_sgs <- GetBCBData::gbcbd_get_series(
...
```{r mba26, fig.cap = 'Taxas de Juros: Variação Interanual e Anual'}
## Interanual
