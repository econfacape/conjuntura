...
``` {r mba12, fig.cap = 'Figura 10: Variação Anual'}
...
![Figura 11: Juro Real x Juro Neutro](img_r/img1.png){width="100%"} 
...
```{r mba13, fig.cap = 'Figura 12: Evolução Índices de Preços em Países selecionados'}
library(wbstats)
...
```{r mba14, fig.cap = 'Figura 13: Evolução Inflação em países selecionados'}
